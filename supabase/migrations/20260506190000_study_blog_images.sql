-- Store study posts as blog-like records with image URLs in metadata.

drop function if exists public.submit_study_record(uuid, uuid, text, text, integer, timestamptz, text);
...
begin
  ...
  perform public.create_audit_log(
    ...
    jsonb_build_object(
      ...
      'imageCount', array_length(v_image_urls, 1)
    ),
    null,
